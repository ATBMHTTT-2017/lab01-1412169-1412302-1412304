...
grant ACCESS_DUAN_DBA to bt_dba;
grant execute on sa_components to bt_dba;
grant execute on sa_label_admin to bt_dba;
grant execute on sa_policy_admin to bt_dba;
grant execute on sa_user_admin to bt_dba;
--cau10

execute sa_sysdba.create_policy('ACCESS_CHITIEU','OLS_CHITIEU');
grant ACCESS_CHITIEU_DBA to bt_dba;
